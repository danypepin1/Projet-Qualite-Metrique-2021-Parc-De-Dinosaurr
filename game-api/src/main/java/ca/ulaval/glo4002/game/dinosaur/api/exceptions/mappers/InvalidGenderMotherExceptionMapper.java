...
@Provider
public class InvalidGenderMotherExceptionMapper implements ExceptionMapper<InvalidGenderMotherException> {
    private static final String ERROR_CODE = "INVALID_MOTHER";
    private static final int HTTP_STATUS = 400;

    @Override
    public Response toResponse(InvalidGenderMotherException exception) {
