...
@Provider
public class NonPositiveDinosaurWeightExceptionMapper implements ExceptionMapper<NonPositiveDinosaurWeightException> {
    private static final String ERROR_CODE = "INVALID_WEIGHT";
    private static final int HTTP_STATUS = 400;

    @Override
    public Response toResponse(NonPositiveDinosaurWeightException exception) {
