...
@Provider
public class InvalidDinosaurGenderExceptionMapper implements ExceptionMapper<InvalidDinosaurGenderException> {
    private static final String ERROR_CODE = "INVALID_GENDER";
    private static final int HTTP_STATUS = 400;

    @Override
    public Response toResponse(InvalidDinosaurGenderException exception) {
